module.exports = function mekeGetServiceListFromResponse(){
    return function getServiceListFromResponse(serverResponse){
        ...
        let serviceList = JSON.parse(response.return.$value);
